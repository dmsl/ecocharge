...
SESSION_FILE_DIR = '/var/www/ecochargeplus/flask_session'
app.config["SESSION_PERMANENT"] = False  # Sessions expire when the browser is closed
app.config["SESSION_COOKIE_SECURE"] = True  # Needed on HTTPS
app.config["SESSION_FILE_DIR"] = '/var/www/ecochargeplus/flask_session'

Session(app)

DATABASE_FILE = os.getenv("DATABASE_FILE", "/var/www/ecochargeplus/.data/MicroGrid.db")
...
# =========================
# Nodes / Nearby Chargers / Forecast Ranking
# =========================
...
# =========================
# Forecast Files / Forecast Solar Scoring
# =========================
...
@app.route('/api/daily_forecast')
def daily_forecast():
    path = os.path.join(app.root_path, 'static', 'forecast', 'daily_forecast.json')
...
# =========================
# Charger Types / Microgrid Details / Hourly Today
# =========================
...
# =========================
# Microgrid / Charger Update Routes
# =========================
